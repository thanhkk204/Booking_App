        ...
        <div className="grid md:grid-cols-3 gap-[50px]">
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text__para text-[14px] md:text-[15px] leading-5 lg:max-w-[390px]">
                  Lorem ipsum dolor sit amet consectetur. Modi, atque
                  necessitatibus! Minima sunt, doloribus veritatis quibusdam,
                  perferendis, iente officia eos?
                </p>
              </div>
            </div>
            ...
            <div className="mt-[50px]">
                {
                  tab === 'about' ? <DoctorAbout/> : <DoctorFeadback/>
                }
            </div>
          </div>
